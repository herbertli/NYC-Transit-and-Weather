...
public class WeatherCleaner {
    ...
    public static class WeatherMapper extends Mapper<LongWritable, Text, LongWritable, Text> {
    ...
    public static class WeatherReducer extends Reducer<LongWritable, Text, LongWritable, Text> {
        @Override
